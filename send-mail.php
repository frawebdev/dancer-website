<?php
	...
	// site owner
	$site_name = 'Sito Web Francesca';
	$sender_domain = 'info@francescaferrari.org';
	$to = 'info@francescaferrari.org';
	//$bcc = 'advert@digitecconsulting.co.uk';
	
	// contact form fields
	$name = trim( $_POST['name'] );
	$email = trim( $_POST['email'] );
	$subject = 'Richiesta Sito Web Online Francesca';
